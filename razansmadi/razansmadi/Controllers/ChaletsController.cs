...
namespace razansmadi.Controllers
{
    public class ChaletsController : Controller
    {
        ...
        [HttpPost]
        public ActionResult UpdateIsAccepted(int itemId, bool? isAccepted)
        {
            // Retrieve the item from the database using the item ID.
            var item = db.Chalets.Find(itemId);

            // Update the "isAccepted" property of the item.
        ...
        public ActionResult AddComment(int ChaletID, string comment1, string returnUrl)
        {
