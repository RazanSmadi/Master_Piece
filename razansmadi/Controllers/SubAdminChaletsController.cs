...
namespace razansmadi.Controllers
{
    public class SubAdminChaletsController : Controller
    {
        ...
        // GET: SubAdminChalets
        public ActionResult Index(string id = "0dfcd31a-12ff-430c-a1a0-a24170377bc9")
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ChaletID,userid,Chalet_Name,Chalet_Description,Chalet_Address,AvailabilityFlag,NnmberOfAdult,NnmberOfkid,PricePerNight,Images_ID,Features_ID,isAccepted,bedroom,bathroom,area,map")] Chalet chalet)
        {
